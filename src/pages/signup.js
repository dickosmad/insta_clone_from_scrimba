...
export default function SignUp() {
  ...
  /*
   * Create a 'handleSignUp' async function (the work inside the function must be in a try/catch)
   * that uses the firebase -> auth -> function 'createUserWithEmailAndPassword' - see references!
   */
    ...
    if (!usernameExists.length) {
      try {
        ...
        await createdUserResult.user.updateProfile({
          // Update the user's profile, specifically the 'displayName'
          // field with the username that the user has inputted (which is stored in state)
